...
function GMGenie.Spawns.onLoad()
    UIDropDownMenu_Initialize(GMGenie_Spawns_Main_ForwardBackward_Dropdownbuttons,
        GMGenie.Spawns.loadDropdownForwardBackward, "MENU");
    UIDropDownMenu_Initialize(GMGenie_Spawns_Main_LeftRight_Dropdownbuttons, GMGenie.Spawns.loadDropdownLeftRight,
        "MENU");
...
function GMGenie.Spawns.initiateMove(option)
    ...
    if not (GMGenie.Spawns.currentCoords.x and GMGenie.Spawns.currentCoords.y and GMGenie.Spawns.currentCoords.z and
        GMGenie.Spawns.currentCoords.o and GMGenie.Spawns.currentCoords.map) then
        SendChatMessage(".gps", "GUILD");
        GMGenie.Spawns.waitingForGps = 1;
    else
        GMGenie.Spawns.move(GMGenie.Spawns.currentCoords.x, GMGenie.Spawns.currentCoords.y,
            GMGenie.Spawns.currentCoords.z, GMGenie.Spawns.currentCoords.o);
    end
...
function GMGenie.Spawns.move(x, y, z, o)
    ...
    SendChatMessage(".go xyz " .. x .. " " .. y .. " " .. z .. " " .. GMGenie.Spawns.currentCoords.map .. " " .. o,
        "GUILD");
    GMGenie.Spawns.updateView();
end
...
function GMGenie.Spawns.scheduleGo(forwardBackward, leftRight, upDown, rotate, rotateDir, option, id)
    Chronos.schedule(GMGenie.Spawns.macroScheduleTime, GMGenie.Spawns.go, forwardBackward, leftRight, upDown, rotate,
        rotateDir, option, id)
...
function SetItemRef(link, text, button, chatFrame)
    if (strsub(link, 1, 16) == "gameobject_entry") or (strsub(link, 1, 14) == "creature_entry") or
        (strsub(link, 1, 10) == "gameobject") or (strsub(link, 1, 8) == "creature") then
